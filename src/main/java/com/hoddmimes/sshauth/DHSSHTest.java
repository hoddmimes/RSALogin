...
public class DHSSHTest
{
    ...
    private void verificationTest(SSHKeyAuthorizationDH client, SSHKeyAuthorizationDH server, String usageMessage) throws Exception
    {
